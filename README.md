...
## Algorithm
1. Load the employee dataset and preprocess it (handle missing values, encode data).
...
5. Predict and evaluate the model using the test data.
...
## Output:
<img width="1034" height="468" alt="image" src="https://github.com/user-attachments/assets/786d24f5-ef9c-4951-9f0e-367fecb942c3" />


<img width="876" height="537" alt="image" src="https://github.com/user-attachments/assets/bd6b8fb0-edae-45e4-8a13-1d037bbedc13" />


<img width="973" height="717" alt="image" src="https://github.com/user-attachments/assets/a935123a-abd4-4fe8-801a-d45878947495" />

<img width="1353" height="96" alt="image" src="https://github.com/user-attachments/assets/53c7029c-da8b-4564-8a3a-b23fe21c45dc" />
